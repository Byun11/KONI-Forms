...
export interface BrowserContextConfig {
  ...
  /**
   * Page observation source. 'axtree' reads the accessibility tree over CDP
   * (controls carry their accessible name; labels/headings appear as context
   * lines); 'dom' is the injected buildDomTree walk (ablation).
   * @default 'axtree'
   */
